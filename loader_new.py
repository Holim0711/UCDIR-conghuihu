...
def folder_content_getter(folder_path, dataset, domain, is_train, is_split):
    ...
    if is_split:
        for cate_name in cate_names:
            split_folder = f'./image_split/{dataset}/{domain}/{cate_name}' 
            if is_train:
                split_text = open(f'{split_folder}/train.txt', 'r')
            else: 
                split_text = open(f'{split_folder}/test.txt', 'r')
            image_paths = list(np.sort(split_text.readlines()))
...
class EvalDataset(data.Dataset):
    def __init__(self,
        ...
        self.datasetA_dir = f'/datasets/{dataset}/images/{domainA}'
        self.datasetB_dir = f'/datasets/{dataset}/images/{domainB}'
        ...
        self.image_paths_A, self.image_cates_A = folder_content_getter(self.datasetA_dir, dataset, domainA, False, is_split)
        self.image_paths_B, self.image_cates_B = folder_content_getter(self.datasetB_dir, dataset, domainB, False, is_split)
...
class TrainDataset(data.Dataset):
    def __init__(self,
        ...
        self.image_paths_A, self.image_cates_A = folder_content_getter(self.datasetA_dir, dataset, domainA, True, is_split)
        self.image_paths_B, self.image_cates_B = folder_content_getter(self.datasetB_dir, dataset, domainB, True, is_split)
...
class TrainDetDataset(data.Dataset):
    def __init__(self,
                 dataset,
                 domainA,
                 domainB,
